...
NumberTickerInput.propTypes = {
  ...
  significantContainerStyle: View.propTypes.style,
  significantTickerStyle: View.propTypes.style,
  decimalContainerStyle: View.propTypes.style,
  decimalTickerStyle: View.propTypes.style,
